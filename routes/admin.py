...
@admin_bp.route('/test-email-send')
@login_required
def test_email_send():
    import smtplib, os
    ...
    try:
        ...
        msg['Subject'] = 'Denspark Test Email'
        msg['From']    = gmail_user
        msg['To']      = admin_email
        msg.attach(MIMEText('This is a test email from Denspark Studio.', 'plain'))

        with smtplib.SMTP_SSL('smtp.gmail.com', 465, timeout=10) as server:
            server.login(gmail_user, gmail_password)
            server.sendmail(gmail_user, admin_email, msg.as_string())

        return jsonify({'success': True, 'message': 'Email sent — check your inbox and spam!'})
